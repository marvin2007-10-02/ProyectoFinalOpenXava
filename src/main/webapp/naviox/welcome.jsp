...
In bfavocabulario-labels_en.properties:
bfavocabulario=My application
bfavocabulario[description]=My application does this and that

In bfavocabulario-messages_en.properties:
